...
# изображения
bg_img = pg.image.load('src/src/background.png')
icon_img = pg.image.load('src/src/ufo.png')
...
font = pg.font.Font('src/src/04B_19.TTF', 48)
...
# игрок
player_img = pg.image.load('src/src/player.png')
...
# пуля
bullet_img = pg.image.load('src/src/bullet.png')
...
# противник
enemy_img = pg.image.load('src/src/enemy.png')
...
def enemy_model():
    ...
    if bullet_alive:
        ...
        if is_crossed:
            ...
            enemy_create()
            bullet_alive = False
            score += 1  # увеличиваем счетчик убийств
